...
using WinUIExtentions.Property;

namespace WinUIExtentions.Services.NavigationViews.Bases;
...
public class NavigationViewServiceBase : INavigationViewService
{
    ...
    void ItemInvoked(NavigationViewItemInvokedEventArgs eventArgs)
    {
        ...
        else
        {
            ...
            if (selectedItem?.GetValue(NavigationItemClickHelper.NavigationKeyProperty) is string pageKey)
            {
